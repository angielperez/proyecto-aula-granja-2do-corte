 ...
 * @author andre
 */
public class VistaGestionIngreso extends javax.swing.JFrame {
    ...
    private IngresoGestion gestion = new IngresoGestion();

    public VistaGestionIngreso(String escenario) {
    ...
    public void Buscar() {
        ...
        if (codigo.isBlank()) {
            ...
            Ingreso ingreso = gestion.buscar(codigo);
            if (ingreso != null) {
                String valor = String.valueOf(ingreso.getValor());
                this.txtValorIngreso.setText(valor);
                this.txtDescripcion.setText(ingreso.getDescripcion());
                this.txtCodigo.setText(ingreso.getCodigo());

                this.labelFecha.setVisible(true);
                this.labelFecha.setText("Fecha: " + ingreso.getFecha().toString());
                ...
                JOptionPane.showMessageDialog(null, "El Ingreso no existe", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void Guardar() {
        try {
            String valor = this.txtValorIngreso.getText();

            String descripcion = this.txtDescripcion.getText();
            String codigo = this.txtCodigo.getText();

            if (valor.isBlank()) {
                JOptionPane.showMessageDialog(null, "El del Ingreso es obligatorio", "Error", JOptionPane.ERROR_MESSAGE);
                ...
                if (this.escenario.equals("EDITAR")) {
                    Ingreso ingresoConDatosAntiguos = gestion.buscar(codigo);
                    ingreso.setFecha(ingresoConDatosAntiguos.getFecha());
                }
                double valordouble = Double.parseDouble(valor);
                ingreso.setValor(valordouble);
                ...
                if (this.escenario == "REGISTRAR") {
                    respuestaGuardado = gestion.guardar(ingreso);
                }

                if (this.escenario == "EDITAR") {
                    respuestaGuardado = gestion.actualizar(codigo, ingreso);
                }
    ...
    private void initComponents() {
        ...
        tituloGranja.setText("GESTION INGRESO ");
        ...
        getContentPane().add(btnRegistrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 330, 130, 30));
        ...
        getContentPane().add(btnVolver, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 330, 130, 30));
        ...
        jLabel6.setText("Valor del Ingreso:");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 240, -1, -1));

        txtValorIngreso.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtValorIngresoActionPerformed(evt);
            }
        });
        getContentPane().add(txtValorIngreso, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 240, 170, -1));
    ...
    private void txtValorIngresoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtValorIngresoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtValorIngresoActionPerformed
    ...
    public static javax.swing.JTextField txtValorIngreso;
