...
public class VistaGestionAlimentacion extends javax.swing.JFrame {
    ...
    public void Buscar() {
        ...
        if (codigo.isBlank()) {
            ...
            if (gallina != null) {
                this.txtCantidadAlimento.setEnabled(true);
    ...
    public void Guardar() {
        try {
            String codigo = this.txtCodigo.getText();
            String cantidad = this.txtCantidadAlimento.getText();
            if (codigo.isBlank()) {
                JOptionPane.showMessageDialog(null, "El campo de codigo es obligatorio", "Error", JOptionPane.ERROR_MESSAGE);
                ...
                if (gallina == null) {
                    ...
                    alimentacion.setCantidadAlimiento(cantidadEntero);
                    alimentacion.setFecha(fecha);

                    String respuestaGuardado = gestion.guardar(alimentacion, codigo);
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnRegistrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 230, 130, 30));
        ...
        getContentPane().add(Volver, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 230, 130, 30));
        ...
        jLabel8.setText("Cantidad de Alimento: ");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 190, -1, -1));

        txtCantidadAlimento.setEnabled(false);
        txtCantidadAlimento.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtCantidadAlimentoActionPerformed(evt);
            }
        });
        getContentPane().add(txtCantidadAlimento, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 190, 110, -1));
    ...
    private void txtCantidadAlimentoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtCantidadAlimentoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtCantidadAlimentoActionPerformed
    ...
    public static javax.swing.JTextField txtCantidadAlimento;
